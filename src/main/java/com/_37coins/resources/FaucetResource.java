...
import com._37coins.FiatPriceProvider;
import com._37coins.PriceTick;
import com._37coins.SignupEvent;
...
public class FaucetResource {
    ...
    @POST
    public int receive(SignupEvent signup) throws JsonProcessingException{
